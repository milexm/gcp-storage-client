...
public class ProjectOperations {
	 ...
	 * @param projectId The default value to use for the project ID.
	 */
	public static void initProjectOperations(Storage authorizedServiceClient, String projectId) {	
	...
	public static void listBuckets() throws IOException {
		...
		Storage.Buckets.List listBuckets = 
				storageService.buckets().list(project);

...
/***
 * Performs object upload. 
 * This class is just a container. The actual work is done by the contained classes:
 * @see RandomDataBlockInputStream 
 * @see CustomUploadProgressListener
 * @author Michael
 *
 */

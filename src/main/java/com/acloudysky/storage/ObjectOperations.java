...
public class ObjectOperations {
	...
	private static StorageDefaultSettings settings;
	 ...
	 */
	public static void initObjectOperations(Storage authorizedServiceClient, 
			StorageDefaultSettings defaultSettings) {
